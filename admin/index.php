          ...
          <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul id="active" class="nav navbar-nav side-nav">
                    ...
                    <li><a href="pages/portfolio.php"><i class="fa fa-tasks"></i> Portfolio</a></li>
                    <li><a href="pages/blog.php"><i class="fa fa-globe"></i> Blog</a></li>
                    <li><a href="pages/signup.php"><i class="fa fa-list-ol"></i> SignUp</a></li>
                    <li><a href="pages/register.php"><i class="fa fa-font"></i> Register</a></li>
                    <li><a href="pages/timeline.php"><i class="fa fa-font"></i> Timeline</a></li>
                    <li><a href="pages/forms.php"><i class="fa fa-list-ol"></i> Forms</a></li>
                    <li><a href="pages/typography.php"><i class="fa fa-font"></i> Typography</a></li>
                    <!-- <li><a href="pages/bootstrap-elements.php"><i class="fa fa-list-ul"></i> Bootstrap Elements</a></li>
                    <li><a href="pages/bootstrap-grid.php"><i class="fa fa-table"></i> Bootstrap Grid</a></li> -->
                </ul>
